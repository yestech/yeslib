...
public class CryptoUtilsUnitTest {
    ...
    {
        String encrypt = CryptoUtils.encrypt("NzwxkjkRhMGmbJjN0Bqz2Q==",
                "This is a secret");
    ...
    {
        String decrypt = CryptoUtils.decrypt("NzwxkjkRhMGmbJjN0Bqz2Q==",
    ...
    {
        String encrypt = CryptoUtils.encryptBase64("NzwxkjkRhMGmbJjN0Bqz2Q==",
        "This is top secret");
        assertNotNull(encrypt);
        assertTrue(StringUtils.isNotBlank(encrypt));
    ...
    {
        String decrypt = CryptoUtils.decryptBase64("NzwxkjkRhMGmbJjN0Bqz2Q==",
