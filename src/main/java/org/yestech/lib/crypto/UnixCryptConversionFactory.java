 ...
 * @version $Revision: $
 */
public class UnixCryptConversionFactory implements IPasswordConversionFactory{

    @Override
    public String transform(String password, Object... params) {
        String convertedPassword = null;
        if (params == null || params.length < 1) {
            convertedPassword = toUnixCrypt(password);
        } else {
            convertedPassword = toUnixCrypt(params[0].toString(), password);
        }
        return convertedPassword;
    }

   /**
     * Convert a String to a Unix Crypt Representation.  Usually salt is the username
     * and original is the clear text password.
     *
     * @param original Unencrypted value
     * @return The encrypted value
     */
    private String toUnixCrypt(String original) {
        ...
        return toUnixCrypt(salt.toString(), original);
    }

    /**
     * Convert a String to a Unix Crypt Representation.  Usually salt is a random string
     * and original is the clear text password.
     *
     ...
     * @return The encrypted value
     */
    private String toUnixCrypt(String salt, String original) {
